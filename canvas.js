...
function createLayerSketch(){
	layers.forEach((layer, layerIndex) => {
		...
		const sketch = function(p) {
			const p5Functions = ['createCanvas', 'background', 'fill', 'stroke', 'noStroke', 'noFill', 
                    'ellipse', 'rect', 'line', 'point', 'triangle', 'quad', 'arc', 'strokeJoin', 'int',
                    'translate', 'rotate', 'scale', 'push', 'pop', 'frameCount', 'deltaTime', 'rectMode',
                    'width', 'height', 'mouseX', 'mouseY', 'sin', 'cos', 'tan', 'atan2', 'min', 'max', 'millis',
					...
					'createVector', 'noLoop', 'createGraphics', ];
